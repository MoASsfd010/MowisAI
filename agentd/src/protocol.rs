...
/// - Global Orchestrator ↔ Runtime (provisioning, health)
/// - Global Orchestrator ↔ Local Hub Agent (task assignment, completion)
/// - Local Hub Agent ↔ Worker Agent (task breakdown, signals)
/// - Local Hub Agent ↔ Local Hub Agent (cross-team contracts)
/// - Worker Agent ↔ Runtime (idle signals, resource requests)
